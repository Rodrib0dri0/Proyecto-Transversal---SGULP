...
public class VistaAlumno extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Gestión de Alumnos");
    ...
    private void jBEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarActionPerformed
        // TODO add your handling code here:
        int idEliminar = Integer.parseInt(jCID.getSelectedItem().toString());

        Alumno aluEliminar = ad.buscarAlumno(idEliminar);
        if (aluEliminar == null) {
            JOptionPane.showMessageDialog(null, "El alumno no existe o ya fue eliminado.");
        } else {
            ad.eliminarAlumno(aluEliminar);
        }
        cargarTabla();
        limpiar();
        cargarID();

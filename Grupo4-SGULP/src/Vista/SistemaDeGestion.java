...
public class SistemaDeGestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Gestión de inscripción");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        vi.setVisible(true);
        vi.setSize(vi.getWidth(),vi.getHeight());
        Escritorio.add(vi);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        VistaListarInscripciones vli = new VistaListarInscripciones();
        vli.setVisible(true);
        vli.setSize(vli.getWidth(),vli.getHeight());
        Escritorio.add(vli);
